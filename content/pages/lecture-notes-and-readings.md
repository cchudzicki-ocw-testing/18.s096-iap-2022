...
- See also the [adjoint sensitivity analysis](https://docs.sciml.ai/SciMLSensitivity/stable/) and [automatic sensitivity analysis](https://diffeq.sciml.ai/stable/analysis/sensitivity/) sections of Chris's amazing [DifferentialEquations.jl software suite](https://diffeq.sciml.ai/stable/) for numerical solution of ODEs in Julia. 
